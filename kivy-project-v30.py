...
class Program(App):
    def build(self):
        ...
        a = 1
        while a == 1:
            self.havadurumu = input("Hava durumunu giriniz: ") # Hava durumu için hangi görsellerin kullanılacağı belirlendiği yer. Hava Durumu Görsel Belirleme Referans Adresi: https://openweathermap.org/weather-conditions
            ...
            if self.havadurumu == "Açık Hava":
                ...
                a = 0
            elif self.havadurumu == "Bulutlar" or "Dağınık Bulutlar" or "Kırık Bulutlar":
                self.havadurumu = "D:/Python Projeler/Kivy\kivy-gorseller/bulutlu-gorsel.png"
                a = 0
            elif self.havadurumu == "Duş Yağmuru" or "Yağmur" or "Fırtına":
